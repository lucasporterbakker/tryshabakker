...
// module
exports.push([module.i, ".type-title {\n  height: 14px;\n  font-size: 14px;\n  font-weight: 500;\n  line-height: 1;\n  letter-spacing: 1.3px;\n  text-align: center;\n  color: #f46116; }\n\n.type-desc {\n  height: 25px;\n  font-size: 18px;\n  font-weight: bold;\n  line-height: 1.56;\n  letter-spacing: normal;\n  text-align: left;\n  padding-top: 0px;\n  padding-bottom: 25px;\n  opacity: 90%;\n  color: #2C2C2C; }\n\n.modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background: rgba(0, 0, 0, 0.6); }\n  .modal .modal-main {\n    /*position: fixed;*/\n    background: white;\n    margin: auto;\n    max-width: 200px;\n    height: auto;\n    padding: auto;\n    /*top: 50%;*/\n    /*left: 50%;*/\n    /*transform: translate(-50%, -50%);*/ }\n\n.display-block {\n  display: block; }\n\n.display-none {\n  display: none; }\n\n*,\n*::before,\n*::after {\n  box-sizing: border-box; }\n\nhtml {\n  background-color: #FFFFFF; }\n\nbody {\n  background-color: #FFFFFF;\n  font-family: 'Heiti SC','Roboto','Helvetica Neue', Helvetica, Arial, sans-serif;\n  font-style: normal;\n  font-weight: 400;\n  letter-spacing: 0;\n  padding: 1rem;\n  text-rendering: optimizeLegibility;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  -moz-font-feature-settings: \"liga\" on; }\n\nimg {\n  height: auto;\n  max-width: 100%;\n  vertical-align: middle; }\n\n.btn {\n  background-image: linear-gradient(to right, #0E86FE, #00C3FF);\n  border: 1px solid #FFFFFF;\n  border-radius: .4rem;\n  color: #FFFFFF;\n  font-size: bold;\n  padding: 0.5rem;\n  text-transform: lowercase; }\n\n.btn--block {\n  display: block;\n  width: 100%; }\n\n.cards {\n  display: flex;\n  flex-wrap: wrap;\n  list-style: none;\n  margin: 0;\n  padding: 0; }\n\n.checkout-price {\n  padding-top: 0px; }\n\n.checkout-container {\n  margin: 2% auto;\n  padding: 50px;\n  width: 80%;\n  min-width: 80%;\n  min-height: 610px;\n  background-image: linear-gradient(to right, #F8F8FD, #FFFFFF);\n  border-radius: 10px;\n  box-shadow: 0 20px 40px -14px rgba(0, 0, 0, 0.25);\n  overflow: hidden; }\n\n.main-checkout-container {\n  padding-bottom: 50px; }\n  .main-checkout-container body {\n    background-image: linear-gradient(to right, #0E86FE, #00C3FF); }\n\n.end-of-total {\n  margin-bottom: 0px; }\n\n.radio-spacing {\n  padding: 15px;\n  text-align: center; }\n\n.inner-checkout-container {\n  width: 70%;\n  margin: auto;\n  text-align: center; }\n  .inner-checkout-container .double-thin {\n    width: 50%;\n    margin: auto;\n    line-height: 1rem; }\n    @media (max-width: 56rem) {\n      .inner-checkout-container .double-thin {\n        width: 100%; } }\n\n.payment-options {\n  padding-bottom: 25px; }\n\n.pay-with-tag {\n  padding-bottom: 15px; }\n\n.cards__item {\n  display: flex;\n  padding: 1rem; }\n  @media (min-width: 40rem) {\n    .cards__item {\n      width: 50%; } }\n  @media (min-width: 56rem) {\n    .cards__item {\n      width: 33.3333%; } }\n  @media (max-width: 40rem) {\n    .cards__item {\n      width: 100%; } }\n\n.card {\n  background-image: linear-gradient(to right, #F8F8FD, #FFFFFF);\n  border-radius: 0.25rem;\n  border: none;\n  box-shadow: 0 20px 40px -14px rgba(0, 0, 0, 0.25);\n  display: flex;\n  text-align: left;\n  min-width: 100%;\n  flex-direction: column;\n  overflow: hidden; }\n  .card:hover .card__image {\n    filter: contrast(100%); }\n\n.benefits {\n  height: 100px;\n  text-align: left; }\n\n.plan-details {\n  padding-top: 20px;\n  height: 5px;\n  text-align: left; }\n\n.price-font {\n  color: #2C2C2C;\n  font-size: 1.8rem;\n  font-weight: bold;\n  text-align: center;\n  padding: 20px; }\n\n.card__content {\n  display: flex;\n  flex: 1 1 auto;\n  flex-direction: column;\n  padding: 1rem; }\n\n.card__image {\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  border-top-left-radius: 0.25rem;\n  border-top-right-radius: 0.25rem;\n  filter: contrast(70%);\n  overflow: hidden;\n  position: relative;\n  transition: filter 0.5s cubic-bezier(0.43, 0.41, 0.22, 0.91); }\n  .card__image::before {\n    content: \"\";\n    display: block;\n    padding-top: 56.25%; }\n  @media (min-width: 40rem) {\n    .card__image::before {\n      padding-top: 66.6%; } }\n\n.card__image--record {\n  background-image: url(https://unsplash.it/800/600?image=39); }\n\n.card__image--fence {\n  background-image: url(http://res.cloudinary.com/donw16xff/image/upload/v1535707022/SAASKWATCH_WHITE.png); }\n\n.card__title {\n  color: #696969;\n  font-size: 1.25rem;\n  font-weight: 300;\n  text-align: left;\n  padding-left: 18px;\n  letter-spacing: 2px;\n  text-transform: uppercase; }\n\n.card__text {\n  flex: 1 1 auto;\n  font-size: 0.875rem;\n  line-height: 1.5;\n  margin-bottom: 1.25rem; }\n", ""]);
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('canvas', { id: 'qrcode' })
            ),
            React.createElement(
                'p',
                { 'class': 'text-center' },
...
const Pricing = __webpack_require__(/*! ./pricing.jsx */ "./src/pricing.jsx");
const Checkout = __webpack_require__(/*! ./checkout.jsx */ "./src/checkout.jsx");
// let {
//     Route,
//     HashRouter
...
const WIDGET_PATTERN_ROOT =  false ? undefined : 'widget\\.test\\/dist';
...
function getQueryParameters(query) {
    ...
    return query.split('&').map(arg => arg.split('=')).map(([key, value]) => [decode(key), decode(value)]).reduce((r, [key, value]) => {
        r[key] = value;
        return r;
    }, {});
}
...
async function getPlans() {
    ...
    class App extends React.Component {
        ...
        render() {
            switch (this.state.state) {
                case 'checkout':
                    return React.createElement(Checkout, { state: this.state, ROOT: ROOT, COMPANY: COMPANY,
                ...
                case 'success':
                    ...
                    break;
                default:
                    return React.createElement(Pricing, { state: this.state, setState: this.setState.bind(this) });
            }
            // return (
            //     <div>
    ...
    ReactDOM.render(React.createElement(App, null), appendTo);
}
...
const WeChatPay = __webpack_require__(/*! ./WeChatPay.jsx */ "./src/WeChatPay.jsx");
...
module.exports = class Checkout extends React.Component {
    ...
    async pay(e) {
        ...
        const elements = e.target.elements,
              { plan, channel } = this.state;
        console.log(elements);
        if (elements.confirmEmail.value !== this.state.email) return this.setState({ error: 'Emails are different' });
        const s4 = () => Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
        let user = Object.entries(elements).map(([, e]) => e.name).filter(k => k.startsWith('user.')).map(key => [key.slice(5), elements[key].value]);
        let errorFields = user.filter(([_, v]) => v == null || v === '');
        if (errorFields.length > 0) return this.setState({ error: 'All needs to be filled in: ' + errorFields.map(([k]) => k) });
    ...
    async WeChatPay() {
        ...
        if (data.result_code === 'FAIL') return this.setState({ error: data.err_code_des });
        this.showProgress();
        let codeUrl = data.code_url;
        console.log('url', codeUrl);
        QRCode.toCanvas(document.getElementById('qrcode'), codeUrl, err => err ? console.error(err) : console.log('success'));
    }

    async aliPay() {
        this.showProgress('Communicating with AliPay...');
        let data = await Checkout.post(`https://itoqk9bi9l.execute-api.ap-northeast-2.amazonaws.com/latest/companies/${this.props.COMPANY}/stripe`, this.state.order);
        this.showProgress();
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'p',
                            null,
                            'Confirm plan and continue to payment.'
                        )
                    ),
                    React.createElement(
                        'div',
                        { 'class': 'inner-checkout-container' },
                        React.createElement(
                            'div',
                            { 'class': 'row form-inline border-bottom pb-5 double-thin' },
                            React.createElement('input', { 'class': 'form-control col-12', name: 'user.firstName', placeholder: 'First Name' }),
                            React.createElement('input', { 'class': 'form-control col-12', name: 'user.lastName', placeholder: 'Last Name' }),
                            React.createElement('input', { 'class': 'form-control col-12', name: 'user.email', type: 'email', placeholder: 'email',
                                value: this.state.email, onChange: event => this.setState({ email: event.target.value }) }),
                            React.createElement('input', { 'class': 'form-control col-12', name: 'confirmEmail', type: 'email', placeholder: 'Confirm Email' })
                        ),
                        React.createElement(
                            'div',
                            { 'class': 'row pb5 border-bottom ' },
                            React.createElement(
                                'div',
                                { 'class': 'col' },
                                React.createElement(
                        ...
                        React.createElement(PaymentChannel, { setState: this.setState.bind(this), state: this.state }),
                        React.createElement(
                            'button',
                            { type: 'submit', 'class': 'btn btn-block btn-success', disabled: disabled },
                            'Continue to Payment'
                        )
                    )
                ),
                React.createElement(WeChatPay, { state: this.state })
            )
        );
    }
};
    ...
    render() {
        if (this.state.disabled) {
            return React.createElement(
                'p',
                { 'class': 'alert alert-danger' },
                'You need to config at least 1 payment channel to enable checkout.'
            );
        }
        const { WeChatPay, AliPay } = this.state.switches;
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { 'class': 'form-inline' },
                    WeChatPay && React.createElement(
                        'label',
                        { 'class': 'radio-spacing' },
                        React.createElement('input', { type: 'radio', name: 'channel', value: 'WeChatPay',
                            onChange: this.handleChange }),
                        '\xA0 WeChat Pay'
                    ),
                    AliPay && React.createElement(
                        'label',
                        { 'class': 'radio-spacing' },
                        React.createElement('input', { type: 'radio', name: 'channel', value: 'AliPay',
                            onChange: this.handleChange }),
                        '\xA0 AliPay'
                    ),
                    AliPay && React.createElement(
...
module.exports = class Page extends React.Component {
    ...
    render() {
        const alert = err => React.createElement(
            'p',
            { 'class': 'alert-danger alert' },
            'Should config at least one pricing plan at backend: ',
            JSON.stringify(err)
        );
        try {
            ...
            let planHtml = planList.map((price, id) => React.createElement(
                'li',
                { 'class': 'cards__item' },
                React.createElement(
                    'div',
                    { 'class': 'card' },
                    React.createElement('div', { 'class': 'card__image card__image--fence' }),
                    React.createElement(
                        'div',
                        { 'class': 'card__content' },
                        React.createElement(
                            'div',
                            { 'class': 'card__title plan-details' },
                            price.name
                        ),
                        React.createElement(
                            'p',
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                price.benefitsList.map(benefit => React.createElement(
                                    'dd',
                                    null,
                                    benefit
                                ))
                            ...
                            React.createElement(
                                'button',
                                { 'class': 'btn btn--block card__btn', onClick: () => this.checkout(id) },
                                'Get started'
                            )
                        )
                    )
